...
public class ViewBooks {
    ...
    public static final String ADDED_BOOKS = "Only books with status 'true' were added to the library";
    ...
    public static void printSortedLibrary(Book[] book){
        for(Book b: book){
